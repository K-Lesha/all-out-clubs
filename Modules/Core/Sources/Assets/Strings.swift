...
public enum Strings {
    ...
    /// all about clubs
    public static let clubsTitle = Strings.tr("Localizable", "clubs_title", fallback: "all about clubs")
    ...
    /// Der Club
    public static let clubIntro = Strings.tr("Localizable", "club_intro", fallback: "Der Club ")
    
    /// aus
    public static let clubOutro = Strings.tr("Localizable", "club_outro", fallback: " aus ")
    
    /// hat einen Wert von
    public static let clubValue = Strings.tr("Localizable", "club_value", fallback: " hat einen Wert von ")
    
    /// Millionen Euro
    public static let clubMillionEuro = Strings.tr("Localizable", "club_million_euro", fallback: " Millionen Euro")
    
    //Sortieren
    public static let sortierenButton = Strings.tr("Localizable", "sortieren_button", fallback: "Sortieren")
